...
describe('Api component', () => {
    it("Tasks - Without params should not add query string", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/tasks?')
    })
    ...
    it("Tasks - Having title should add it to the query string", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/tasks?&title=Dummy')
    })
    ...
    it("Tasks - Having title and completed should add it to the query string", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/tasks?&title=Dummy&completed=true')
    })
    ...
    it("Tasks - Having title, completed and offset should add it to the query string", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/tasks?&title=Dummy&completed=true&offset=10')
    })
    ...
    it("Tasks - Having title, completed, offset and limit should add it to the query string", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/tasks?&title=Dummy&completed=true&offset=10&limit=5')
    })
    ...
    it("Tasks - Having title, completed, offset, limit and userId should add it to the query string", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/tasks?&title=Dummy&completed=true&offset=10&limit=5&userId=3')
    })
    ...
    it("Tasks By User - Should request with the user id", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/users/3/tasks?')
    })
    ...
    it("User - Should call will the user id", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/users/3?')
    })
    ...
    it("Get Users - Should call to main user endpoint", async () => {
        ...
        expect(spy).toBeCalledWith('http://localhost:8000/api/users')
    })
